...
\begin{itemize}
    ...
    \img[width=0.7\linewidth]{../plots/dj_const6.pdf}{Circuit diagram for 6-bit Deutsch-Josza for a constant function that always returns 1.}{djc6}
    ...
    \img[width=0.7\linewidth]{../plots/dj_3.pdf}{Circuit diagram for 3-bit Deutsch-Josza for a balanced function.}{dj3}
\end{itemize}
